 ...
 * @author Alan Coello
 */
public class IngresarCamara extends javax.swing.JFrame {
    ...
    /**
     * Creates new form IngresarCamara
     */
    public IngresarCamara() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Camara camara = new Camara(nombre, marca, modelo);

        photoViewer.getCamaras().add(camara);

        //photoViewer.agregarCamara(camara);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IngresarCamara.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IngresarCamara().setVisible(true);
            }
        });
    }
